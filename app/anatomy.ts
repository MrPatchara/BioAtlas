...
export const SYSTEMS: {id:SystemId;name:string;nameTh:string;color:string;description:string;descriptionTh:string}[] = [
 ...
 {id:'cardiac',name:'Heart',nameTh:'หัวใจ',color:'#b96760',description:'Part of the circulatory system centered on the heart, moving blood through the body.',descriptionTh:'ส่วนหนึ่งของระบบไหลเวียนเลือดที่มีหัวใจเป็นศูนย์กลาง ทำหน้าที่สูบฉีดเลือดไปทั่วร่างกาย'},
 ...
 {id:'respiratory',name:'Respiratory',nameTh:'ระบบหายใจ',color:'#b98991',description:'Part of the respiratory system that moves air and exchanges gases with the blood.',descriptionTh:'ส่วนหนึ่งของระบบหายใจที่นำอากาศและแลกเปลี่ยนแก๊สกับเลือด'},
 {id:'digestive',name:'Digestive',nameTh:'ระบบย่อยอาหาร',color:'#b8916b',description:'Part of the digestive system that takes in food and absorbs nutrients.',descriptionTh:'ส่วนหนึ่งของระบบย่อยอาหารที่รับอาหารและดูดซึมสารอาหาร'},
 {id:'urinary',name:'Urinary',nameTh:'ระบบทางเดินปัสสาวะ',color:'#b47961',description:'Part of the urinary system that balances body fluids and expels urine.',descriptionTh:'ส่วนหนึ่งของระบบทางเดินปัสสาวะที่ปรับสมดุลของเหลวและขับปัสสาวะ'},
 ...
 {id:'reproductive',name:'Reproductive',nameTh:'ระบบสืบพันธุ์',color:'#bda098',description:'These male reproductive structures support sperm production and transport, erection, and sex-hormone production.',descriptionTh:'โครงสร้างสืบพันธุ์เพศชายเหล่านี้ ช่วยในการสร้างและขนส่งอสุจิ การแข็งตัว และการสร้างฮอร์โมนเพศ'},
 {id:'integumentary',name:'Body surface',nameTh:'ผิวกาย',color:'#ba9b7d',description:'The body surface provides an outer anatomical reference. The integumentary system forms a protective barrier and contributes to sensation and temperature regulation.',descriptionTh:'ผิวกายเป็นจุดอ้างอิงภายนอก ระบบผิวหนังเป็นเกราะป้องกันและช่วยในการรับความรู้สึกและควบคุมอุณหภูมิ'},
